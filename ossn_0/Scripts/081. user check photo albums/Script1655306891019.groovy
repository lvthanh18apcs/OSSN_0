...
WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_Photos'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_user 1  OSSN/a_Add Album'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/i_Groups_fa fa-th-list'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/li_Photos'))
