...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin 1  OSSN/div_Friends'), 'Friends')

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_admin 1  OSSN/a_Unfriend'))
