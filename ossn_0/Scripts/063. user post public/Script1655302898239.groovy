...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post public from newsfeed')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/span_Privacy'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Public (Everyone can see this.)_privacy'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post public from newsfeed'), 'user post public from newsfeed')
