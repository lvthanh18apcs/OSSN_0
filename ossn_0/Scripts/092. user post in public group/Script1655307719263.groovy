...
WebUI.setText(findTestObject('Object Repository/Page_Public Admin Group  OSSN/textarea_Post_post'), 'user post on public admin group')

WebUI.click(findTestObject('Object Repository/Page_Public Admin Group  OSSN/input_Post_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Public Admin Group  OSSN/p_user post on public admin group'), 
    'user post on public admin group')

WebUI.click(findTestObject('Object Repository/Page_Public Admin Group  OSSN/a_Public_btn btn-link'))

WebUI.click(findTestObject('Object Repository/Page_Public Admin Group  OSSN/a_Delete'))

WebUI.click(findTestObject('Object Repository/Page_Public Admin Group  OSSN/i_OSSN_fa fa-sort-down'))

WebUI.click(findTestObject('Object Repository/Page_Public Admin Group  OSSN/a_Log out'))
