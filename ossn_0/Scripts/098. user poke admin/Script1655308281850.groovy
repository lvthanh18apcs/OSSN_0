...
WebUI.click(findTestObject('Object Repository/Page_Search results for  OSSN/a_admin 1'))

WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/i_Message_fa fa-sort-down'))

WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/a_Poke'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin 1  OSSN/div_You have poked admin 1'), 'You have poked admin 1!')
