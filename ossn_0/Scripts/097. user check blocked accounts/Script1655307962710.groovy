...
WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_Blocking'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_user 1  OSSN/div_Edit'), 'Edit')

WebUI.verifyElementText(findTestObject('Object Repository/Page_user 1  OSSN/span_user 2 (user2)'), 'user 2 (user2)')

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_user 1  OSSN/a_Unblock'))
