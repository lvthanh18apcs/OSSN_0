...
WebUI.setText(findTestObject('Object Repository/Page_Public Admin Group  OSSN/textarea_Post_post'), 'admin post in public group')

WebUI.click(findTestObject('Object Repository/Page_Public Admin Group  OSSN/input_Post_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Public Admin Group  OSSN/p_admin post in public group'), 
    'admin post in public group')

WebUI.click(findTestObject('Object Repository/Page_Public Admin Group  OSSN/i_Public_fa fa fa-ellipsis-h'))
