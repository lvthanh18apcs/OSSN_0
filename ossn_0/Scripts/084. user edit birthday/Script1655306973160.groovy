...
WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/input_Birthdate_birthdate'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_1'))
