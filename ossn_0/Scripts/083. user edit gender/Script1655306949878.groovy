...
WebUI.verifyElementText(findTestObject('Object Repository/Page_user 1  OSSN/div_Edit'), 'Edit')

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/input_Male_gender'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/input_Gender_gender'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_user 1  OSSN/input_Language_btn btn-primary'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/input_Language_btn btn-primary'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_user 1  OSSN/div_User updated'), 'User updated!')
