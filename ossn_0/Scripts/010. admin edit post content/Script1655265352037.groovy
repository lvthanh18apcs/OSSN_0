...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'Admin post to edit from newsfeed')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_Admin post to edit from newsfeed'), 'Admin post to edit from newsfeed')
...
WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/body_Edit        X                         _9e36b1'))

WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Admin post to edit from newsfeed'), 'Admin post edited from newsfeed')
