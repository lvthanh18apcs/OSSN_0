...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post to edit from page')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post to edit from page'), 'user post to edit from page')
...
WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/i_Privacy_fa fa fa-ellipsis-h'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_Edit'))

WebUI.setText(findTestObject('Object Repository/Page_user 1  OSSN/textarea_user post to edit from page'), 'user post edited from page')

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_Save'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_user 1  OSSN/div_Post successfully saved'), 'Post successfully saved')

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_Privacy_btn btn-link'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_Delete'))
