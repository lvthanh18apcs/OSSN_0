...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post to react from newsfeed')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post to react from newsfeed'), 'user post to react from newsfeed')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/a_Like'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/div_Like_emoji__hand'))
