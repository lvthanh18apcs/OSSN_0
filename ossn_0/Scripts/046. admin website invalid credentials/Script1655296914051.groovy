...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Login  OSSN/div_Invalid username or password'), 'Invalid username or password!')

WebUI.setText(findTestObject('Object Repository/Page_Login  OSSN/input_Username_username'), 'user2')
