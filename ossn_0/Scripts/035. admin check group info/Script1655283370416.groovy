...
WebUI.click(findTestObject('Object Repository/Page_Public Admin Group  OSSN/a_Group About'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Public Admin Group  OSSN/div_Group About'), 'Group About')
...
WebUI.click(findTestObject('Object Repository/Page_Closed Admin Group  OSSN/a_Group About'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Closed Admin Group  OSSN/div_Group About'), 'Group About')
