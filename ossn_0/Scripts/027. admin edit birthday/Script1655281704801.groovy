...
WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/input_Birthdate_birthdate'))

WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/a_1'))
