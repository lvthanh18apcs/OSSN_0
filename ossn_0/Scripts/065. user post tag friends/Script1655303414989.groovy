...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post tag friends from newsfeed')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Tag Friends_fa fa-users'))

WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/input_Post_token-input-ossn-wall-friend-input'), 'admin')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post tag friends from newsfeed'), 
    'user post tag friends from newsfeed')
