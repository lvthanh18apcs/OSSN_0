...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'admin post to tag position')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Tag Friends_fa fa-map-marker-alt'))

WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_location'), 'asdasdasd')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_admin post to tag position'), 'admin post to tag position')
