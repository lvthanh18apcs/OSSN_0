...
WebUI.setText(findTestObject('Object Repository/Page_user 1  OSSN/textarea_Post_post'), 'user post private from own page')

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/i_Tag Friends_fa fa-smile'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/li_'))
...
WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/input_Public (Everyone can see this.)_privacy'))
