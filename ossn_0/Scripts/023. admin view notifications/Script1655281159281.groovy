...
WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/li_Notifications'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Notifications  OSSN/div_Notifications'), 'Notifications')

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Notifications  OSSN/div_Notifications                user 1 has_8d3bdc'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Notifications  OSSN/a'))

WebUI.click(findTestObject('Object Repository/Page_Notifications  OSSN/a_Log out'))
