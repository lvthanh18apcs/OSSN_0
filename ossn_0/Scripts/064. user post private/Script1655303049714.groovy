...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post private from newsfeed')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post private from newsfeed'), 'user post private from newsfeed')
