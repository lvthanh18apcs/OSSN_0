...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin 1  OSSN/div_Edit'), 'Edit')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_admin 1  OSSN/select_GermanGreekEnglishEsperantoSpanishFr_204776'), 
    'es', true)

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_admin 1  OSSN/input_Language_btn btn-primary'))
