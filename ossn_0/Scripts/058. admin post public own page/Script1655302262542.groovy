...
WebUI.setText(findTestObject('Object Repository/Page_admin 1  OSSN/textarea_Post_post'), 'admin post public from own page')

WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/span_Privacy'))

WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/input_Privacy_privacy'))

WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/a_Save'))

WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/li_Tag Friends_ossn-wall-container-control-_07fa90'))

WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/span'))
...
WebUI.click(findTestObject('Page_News Feed  OSSN/i_OSSN_fa fa-sort-down'))
