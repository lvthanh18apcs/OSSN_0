...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/input_Group Name_groupname'), 'User create new group')
...
WebUI.verifyElementClickable(findTestObject('Object Repository/Page_News Feed  OSSN/a_Save'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/a_Cancel'))
