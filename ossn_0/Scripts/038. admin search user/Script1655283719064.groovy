...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/input_Groups_q'), 'user')

WebUI.sendKeys(findTestObject('Object Repository/Page_News Feed  OSSN/input_Groups_q'), Keys.chord(Keys.ENTER))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Search results for user  OSSN/div_user 1                                 _ed47a2'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Search results for user  OSSN/i_OSSN_fa fa-sort-down'))

WebUI.click(findTestObject('Object Repository/Page_Search results for user  OSSN/a_Log out'))
