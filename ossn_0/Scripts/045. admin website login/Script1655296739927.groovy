...
WebUI.click(findTestObject('Object Repository/Page_Dashboard  OSSN/i_Log out_fa fa-bars fa-3'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard  OSSN/a_Log out'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Login  OSSN/div_You are now logged out'), 'You are now logged out!')

WebUI.setText(findTestObject('Object Repository/Page_Login  OSSN/input_Username_username'), 'admin1@test.com')
...
WebUI.click(findTestObject('Object Repository/Page_Dashboard  OSSN/a_Log out_1'))
