...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post to like comment')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post to like comment'), 'user post to like comment')
...
WebUI.click(findTestObject('Page_News Feed  OSSN/a_Like (1)'))

WebUI.click(findTestObject('Page_News Feed  OSSN/div_Delete_emoji  emoji--like (1)'))
