...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'admin post from newsfeed private')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_admin post from newsfeed private'), 'admin post from newsfeed private')
