...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'admin post to comment from newsfeed')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_admin post to comment from newsfeed'), 
    'admin post to comment from newsfeed')

WebUI.setText(findTestObject('Page_News Feed  OSSN/span_Like_comment'), 'admin comment to edit')
...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_admin comment to edit'), 'admin comment edited')
