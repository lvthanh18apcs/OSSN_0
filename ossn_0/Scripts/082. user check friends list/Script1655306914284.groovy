...
WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/li_Friends'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_user 1  OSSN/div_Friends'), 'Friends')

WebUI.verifyElementText(findTestObject('Object Repository/Page_user 1  OSSN/a_admin 1'), 'admin 1')
...
WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_user 1'))

WebUI.click(findTestObject('Object Repository/Page_user 1  OSSN/a_Friends'))
