...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'admin post tag friends from newsfeed')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Tag Friends_fa fa-users'))

WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/input_Post_token-input-ossn-wall-friend-input'), 'user')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_admin post tag friends from newsfeed'), 
    'admin post tag friends from newsfeed')
