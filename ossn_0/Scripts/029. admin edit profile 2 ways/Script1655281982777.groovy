...
WebUI.click(findTestObject('Object Repository/Page_admin 1  OSSN/a_COPYRIGHT OSSN'))
...
WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/a_Account Settings'))
