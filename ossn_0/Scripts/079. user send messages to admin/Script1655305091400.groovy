...
WebUI.setText(findTestObject('Object Repository/Page_Messages  OSSN/textarea__message'), 'hi from user1')

WebUI.click(findTestObject('Object Repository/Page_Messages  OSSN/input__btn btn-primary'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Messages  OSSN/span_hi from user1'), 'hi from user1')
