...
WebUI.setText(findTestObject('Object Repository/Page_Login  OSSN/input_Username_username'), 'user1@test.com')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Login  OSSN/strong_Invalid username or password'), 'Invalid username or password!')
