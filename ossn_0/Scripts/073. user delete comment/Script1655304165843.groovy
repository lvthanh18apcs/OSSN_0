...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post to delete comment')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post to delete comment'), 'user post to delete comment')
...
WebUI.click(findTestObject('Page_News Feed  OSSN/a_Delete (1)'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Privacy_fa fa fa-ellipsis-h'))

WebUI.click(findTestObject('Page_News Feed  OSSN/a_Delete'))
