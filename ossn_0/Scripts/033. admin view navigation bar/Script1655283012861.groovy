...
WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Log out_fa fa-users'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_News Feed  OSSN/div_Friend Requests'), 0)

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Log out_fa fa-users'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Log out_fa fa-envelope'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_News Feed  OSSN/div_Messages'), 0)

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Log out_fa fa-envelope'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Log out_fa fa-globe-americas'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_News Feed  OSSN/div_Notifications'), 0)
