...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post with image from newsfeed')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post with image from newsfeed'), 'user post with image from newsfeed')
