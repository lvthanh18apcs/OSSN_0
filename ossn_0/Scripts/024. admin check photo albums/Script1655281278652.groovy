...
WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/li_Photos'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin 1  OSSN/div_admin 1'), 'admin 1')

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin 1  OSSN/div_Photo Albums'), 'Photo Albums')

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_admin 1  OSSN/a_Add Album'))
