...
WebUI.setText(findTestObject('Object Repository/Page_Closed Admin Group  OSSN/textarea_Post_post'), 'user post on private admin group')

WebUI.click(findTestObject('Object Repository/Page_Closed Admin Group  OSSN/input_Post_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Closed Admin Group  OSSN/p_user post on private admin group'), 
    'user post on private admin group')
