...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/input_Groups_q'), 'admin')

WebUI.sendKeys(findTestObject('Object Repository/Page_News Feed  OSSN/input_Groups_q'), Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Search results for admin  OSSN/a_admin 1'), 'admin 1')

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_Search results for admin  OSSN/a_Unfriend'))

WebUI.click(findTestObject('Object Repository/Page_Search results for admin  OSSN/i_OSSN_fa fa-sort-down'))

WebUI.click(findTestObject('Object Repository/Page_Search results for admin  OSSN/a_Log out'))
