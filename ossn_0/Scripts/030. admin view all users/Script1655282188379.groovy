...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Search results for  OSSN/div_admin 1                                _7981c0'))

WebUI.click(findTestObject('Object Repository/Page_Search results for  OSSN/a'))

WebUI.click(findTestObject('Object Repository/Page_Search results for  OSSN/a_Log out'))
