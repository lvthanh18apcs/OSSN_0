...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'Admin post from newsfeed public')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_Admin post from newsfeed'), 'Admin post from newsfeed public')
