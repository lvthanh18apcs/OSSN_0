...
WebUI.setText(findTestObject('Page_News Feed  OSSN/span_Like_comment'), 'admin comment on post')

WebUI.sendKeys(findTestObject('Page_News Feed  OSSN/span_Like_comment'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/a_Like'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/div_Delete_emoji  emoji--like'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/a_Unlike'))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Privacy_fa fa fa-ellipsis-h'))

WebUI.click(findTestObject('Page_News Feed  OSSN/a_Delete_1'))
