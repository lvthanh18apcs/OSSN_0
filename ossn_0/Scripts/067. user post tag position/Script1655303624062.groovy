...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post to tag position')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post to tag position'), 'user post to tag position')
