...
WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/a_Administrator'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Dashboard  OSSN/div_Dashboard'), 'DASHBOARD')

WebUI.click(findTestObject('Object Repository/Page_Dashboard  OSSN/i_Log out_fa fa-bars'))

WebUI.click(findTestObject('Object Repository/Page_Dashboard  OSSN/a_View Site'))
