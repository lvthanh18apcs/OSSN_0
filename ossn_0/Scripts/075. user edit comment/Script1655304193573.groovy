...
WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_Post_post'), 'user post comment to edit ')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/input_Tag Friends_btn btn-primary ossn-wall-post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/p_user post comment to edit'), 'user post comment to edit')

WebUI.setText(findTestObject('Page_News Feed  OSSN/span_Like_comment'), 'user comment')

WebUI.sendKeys(findTestObject('Page_News Feed  OSSN/span_Like_comment'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/i_Like_fa fa-ellipsis-h'))

WebUI.click(findTestObject('Page_News Feed  OSSN/a_Edit (1)'))

WebUI.setText(findTestObject('Object Repository/Page_News Feed  OSSN/textarea_user comment'), 'user comment edited')

WebUI.click(findTestObject('Object Repository/Page_News Feed  OSSN/a_Save'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_News Feed  OSSN/div_Comment has been edited successfully'), 
